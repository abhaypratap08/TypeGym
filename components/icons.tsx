 ...
 * icons.tsx
 * =========
 * Small shared inline SVG icons used across the typing app and the
 * multiplayer pages, so the markup isn't copy-pasted in three places.
 */
...
/** Footer shared by the practice and multiplayer pages. */
