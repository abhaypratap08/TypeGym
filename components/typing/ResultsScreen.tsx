...
export default function ResultsScreen({
  ...
  return (
    <motion.div
      ...
      role="region"
      aria-label={`Session results: ${wpm} words per minute, ${accuracy} percent accuracy, ${errors} errors, ${perf.label}`}
    >
      {/* Announced once so screen reader users hear the outcome without the live-metrics noise */}
      <span className="sr-only" role="status" aria-live="polite">
        Test complete. {wpm} words per minute, {accuracy} percent accuracy, {perf.label}.
      </span>
