...
export const WORDS_LIST: string[] = [
  ...
  "never","cross","farm","hard","start","might","story","saw","far",
  "form","field","land","travel","true","girl","north","open","seem",
  "together","next","children","begin","side","feet","friend","something",
  "plant","cover","food","sun","four","between","state","never","last",
  "found","still","learn","should","America","world","high","every","near",
  "add","food","between","own","below","country","plant","last","school",
  "father","keep","tree","never","start","city","earth","eyes","light",
  "thought","head","under","story","body","music","color","stand","every",
]
